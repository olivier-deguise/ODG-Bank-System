...
public class UpgradeClient implements Runnable{

    private String clientName;

    private String bankSystemUrl;

    public UpgradeClient(String bankSystemUrl, String clientName){
    ...
    @Override
    public void run(){
        final String uri = this.bankSystemUrl + "client/upgrade";
        ...
        if(response.getStatusCode() == HttpStatus.OK){
            ...
            System.out.println("Client " + this.clientName + " has been upgraded to status " + status + ".");
        }
        else{
